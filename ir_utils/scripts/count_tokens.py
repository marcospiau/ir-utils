...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Path to the tokenizer, will be loaded using AutoTokenizer.from_pretrained",
)
parser.add_argument(
    "--max_lines",
    type=int,
...
parser.add_argument(
    "--nouse_fast_tokenizer", action="store_true", help="Use fast tokenizer"
)
parser.add_argument(
    "--additional_tokens",
    type=int,
...
parser.add_argument(
    "--target_length", type=int, default=512, help="Target length of the documents."
)
parser.add_argument(
    "--output_file", type=str, default=None, help="Path to the output file."
)
parser.add_argument(
    "--num_actors",
    type=int,
...
parser.add_argument(
    "--batch_size", type=int, default=4096, help="How many lines to process at once"
)
...
def main():
    ...
    truncated_counts = pl.from_pandas(truncated_counts.reset_index(names="truncation"))
